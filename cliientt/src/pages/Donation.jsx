        ...
        <div className="max-w-3xl mx-auto mb-16">
          <div className="relative shadow-2xl">
            <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
              <Search className="text-gray-400 w-6 h-6 opacity-70" />
            </div>
            <input
              type="text"
              placeholder="Explore meaningful campaigns..."
              className="w-full pl-16 pr-6 py-4 rounded-xl border-2 border-pink-600/30 bg-gray-800/80 backdrop-blur-sm 
                         text-white placeholder-gray-500 
                         focus:outline-none focus:ring-3 focus:ring-pink-500/50 focus:border-pink-500
